...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./OB_finetun_models',
...
def main(args):
    ...
    if not args.eval:
        args.model_store_dir = os.path.join(args.output_dir, args.model, args.dataset_name, args.model + '_' + args.dataset_name + '_' + args.task)
    else:
    ...
    if args.eval:
        ...
        test_stats, _, auc_roc, macro_aupr = evaluate(data_loader_test, model, device, args, epoch=0, mode='test',
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        val_stats, val_score, val_roc ,val_aupr = evaluate(data_loader_val, model, device, args, epoch, mode='val',
                                        num_class=args.nb_classes, log_writer=log_writer)
        ...
        if misc.is_main_process() and epoch == (args.epochs - 1):
            ...
            test_stats, _,_,_ = evaluate(data_loader_test, model, device, args, -1, mode='test',
